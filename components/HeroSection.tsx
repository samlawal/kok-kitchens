...
// Purely decorative background photos — they sit behind a dark overlay and the
// real headline/CTA text, and auto-rotate. Marked decorative (alt="") so screen
// readers skip them instead of announcing a meaningless food word every 6s.
const heroImages = [
  { src: "/meals/hero-c2.webp", alt: "" },
  { src: "/meals/hero-c4.webp", alt: "" },
  { src: "/meals/hero-c5.webp", alt: "" },
  { src: "/meals/hero-c7.webp", alt: "" },
  { src: "/meals/hero-c8.webp", alt: "" },
  { src: "/meals/hero-c9.webp", alt: "" },
  { src: "/meals/hero-c11.webp", alt: "" },
  { src: "/meals/hero-c15.webp", alt: "" },
  { src: "/meals/hero-c16.webp", alt: "" },
  { src: "/meals/hero-c20.webp", alt: "" },
  { src: "/meals/hero-c21.webp", alt: "" },
  { src: "/meals/hero-c22.webp", alt: "" },
];
...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-stone-950 min-h-[85vh] lg:min-h-[100vh] flex items-center justify-center -mt-16">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
        ...
        >
          <Link
            href="/menu"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-orange-600 px-10 py-4 text-base font-semibold text-white hover:bg-orange-700 active:scale-[0.97] transition-all shadow-lg shadow-orange-600/20 hover:shadow-orange-500/30"
          >
            View Menu & Order
